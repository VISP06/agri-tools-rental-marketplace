...
const equipmentDetailPage = ({ equipment, loggedInUser }) => {
  ...
  const actionButton = isOwner
    ...
    : `<button class="book-equipment rounded-lg bg-emerald-600 px-8 py-3 text-base font-semibold text-white hover:bg-emerald-700 transition-colors shadow-sm" data-book-equipment="${equipment._id}">
